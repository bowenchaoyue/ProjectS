...
public class CipherUtils {
    ...
    public static void main(String[] args) {
        //String data = "1126a6f25aee3d35965695f1d650a7be";
        // data = MD5Encode(data);
        // String key = generateDESKey(AnalyzeKeyConstant.LOGIN_KEY);
        // System.out.println(key);
        // String s = DESEncrypt(data, AnalyzeKeyConstant.LOGIN_KEY);
        // System.out.println(s);
        //String s = DESDecrypt(data, AnalyzeKeyConstant.LOGIN_KEY);
        //System.out.println(s);
    }
